...
var createNewTaskElement = function (taskString) {
  ...
  articleItem.classList = "task";
  checkBox.type = "checkbox";
  checkBox.classList = "main__checkbox";
  editInput.type = "text";
  editInput.className = "task__input main__input";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "main__btn task__edit-btn";

  deleteButton.className = "main__btn task__delete-btn";
  ...
  articleItem.appendChild(editInput);
...
var editTask = function () {
  ...
  var editBtn = listItem.querySelector(".main__btn");
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  listItem.querySelector(".task__name").classList.add("completed__task-name");
...
var taskIncomplete = function () {
  ...
  listItem
    ...
    .classList.remove("completed__task-name");
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector(".main__btn");
